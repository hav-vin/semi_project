...
<head>
	...
	<!--<script type="text/javascript" src="http://ff.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=xJpsfTX-hG5_QwrNSfJX8H4DW2sGxNdWXbg5SWODJQ1_hSLQE8ABlhOTkR6kiIsZU8oNayLzbFLvHuxa6EcBaiIRJ6fjlYmlLIXqeT0Q9uoehlMUYuJw0CYDRF3ZDg4xeLLPmDDeHci7OYwUeJBueQpEr-xmqYqiKg26-uqi2R-EODV-IJwTPmeBGsI-PCxxrvNGjCgAvb3JDd3JyORjOfqFRL0NbaU6IM8-bVeFmfY" charset="UTF-8"></script>-->
	...
	<article class="mix portfolio_category_17 portfolio_category_5  mix_all" style="display: inline-block; opacity: 1;">
	    <div class="image_holder">
	        ...
	        <span class="text_holder"><span class="text_outer"><span class="text_inner"><span class="feature_holder"><span class="feature_holder_icons">
	            <a class="preview qbutton small white" href="funding/funding.do?m=fund_content&pnum=<%=board.getPnum()%>" target="_self">view</a>
...
<!-- 	<article class="mix portfolio_category_17 portfolio_category_5  mix_all" style="display: inline-block; opacity: 1;"> -->
<!-- 	    <div class="image_holder"> -->
<!-- 	        <a class="portfolio_link_for_touch" href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self"><span class="image"><img width="1100" height="825" src="http://demo.qodeinteractive.com/bridge/wp-content/uploads/2013/10/p-design-of-total-mechanics-berlin-design-week-poster.jpg" class="attachment-full wp-post-image" alt="qode interactive strata"></span></a> -->
<!-- 	        <span class="text_holder"><span class="text_outer"><span class="text_inner"><span class="feature_holder"><span class="feature_holder_icons"> -->
<!-- 	            <a class="preview qbutton small white" href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self">view</a></span></span></span></span></span></div><div class="portfolio_description "> -->
<!-- 	    <h5 class="portfolio_title"> -->
<!-- 	        <a href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self">Second Subject</a></h5> -->
<!-- 	    <span class="project_category">Second, Content</span> -->
<!-- 	    </div> -->
<!-- 	</article> -->
	                
<%     
	System.out.println(board.getPiname());
    	}
    }
%>
	        ...
	        <div class="row">
	          <div class="col-md-12">
	            <div class="inner-content">
	              <p>Copyright &copy; 2020 젊피중피 Co., Ltd.</a></p>
	              <br/>
	            </div>
	          </div>
	        </div>
